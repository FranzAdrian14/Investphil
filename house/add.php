			...
			<form action="#" id="manage-house" method="post">
				...
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button type="submit" class="btn btn-sm btn-primary col-sm-3 offset-md-3" name="add_house"> Save</button>
								...
								<tr>
									...
									<td>
										<div class="btn-group" role=""group>
											...
											-->
											<a href="edit.php?house_id=<?=$house->house_id;?>" class="btn btn-outline-warning">Edit</a>
											<a href="confirm_delete.php?house_id=<?=$house->house_id;?>" class="btn btn-outline-danger">Delete</a>
										</div>
									</td>
								</tr>
								<?php endforeach; ?>
